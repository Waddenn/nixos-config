{
  ...
  options.my-services.containers.linkwarden.enable = lib.mkEnableOption "linkwarden container";

  config = lib.mkIf config.my-services.containers.linkwarden.enable {
    # Runtime
    ...
    virtualisation.oci-containers.containers."linkwarden-linkwarden" = {
      ...
      volumes = [
        "/home/nixos/linkwarden/data:/data/data:rw"
      ];
      ports = [
        "3000:3000/tcp"
      ];
    ...
    virtualisation.oci-containers.containers."linkwarden-postgres" = {
      ...
      volumes = [
        "/home/nixos/linkwarden/pgdata:/var/lib/postgresql/data:rw"
      ];
      log-driver = "journald";
      extraOptions = [
