{ config, lib, pkgs, ... }: {
  options.my-services.containers.valheim-server.enable = lib.mkEnableOption "valheim-server container";

  config = lib.mkIf config.my-services.containers.valheim-server.enable {
    # Runtime
