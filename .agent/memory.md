...
- [2026-09-12] Adoption de Cachix (`waddenn-nixos`) comme cache Nix partagé entre les CI de PR, `main` et Colmena ; les PR de forks restent en lecture seule car GitHub ne leur transmet pas `CACHIX_AUTH_TOKEN`.
