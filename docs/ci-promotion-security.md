...
simplification de la CI, les PR prêtes ont uniquement des tests rapides et les
brouillons aucun job ; la CI complète automatique est effectuée sur `main`. Voir la [procédure actuelle](operations.md#branches-de-travail-et-pr).
